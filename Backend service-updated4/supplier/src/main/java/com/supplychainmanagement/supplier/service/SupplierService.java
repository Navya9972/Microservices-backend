...
public class SupplierService {
    ...
    public Supplier saveSupplier(Supplier supplier) {
        Supplier supplier1 = findByEmail(supplier.getSupplierEmail());
        if (supplier1==null){
    ...
    public String getSupplierEmailId(String supplierEmail) {
        Supplier supplier = findByEmail(supplierEmail);
        if (supplier==null){
            return null;
        }
        else{
            return supplier.getSupplierEmail();
        }
    }
}
