...
public class SupplierController {
    ...
    @GetMapping("/getsupplieremail/{email}")
    public String getSupplierEmailId(@PathVariable("email") String supplierEmail){
        return supplierService.getSupplierEmailId(supplierEmail);
    }
}
