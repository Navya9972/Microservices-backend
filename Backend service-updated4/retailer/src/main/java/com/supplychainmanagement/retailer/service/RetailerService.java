...
public class RetailerService {
    ...
    public Retailer saveRetailer(Retailer retailer) {
        Retailer retailer1 = findByEmail(retailer.getRetailerEmail());
        String supplierEmail = getSupplierEmail(retailer.getRetailerEmail());
    ...
    public String getSupplierEmail(String email){
        String supplierEmail = restTemplate.getForObject("http://localhost:3002/supplier/getsupplieremail/"+email,email.getClass());
